...
**The Creasol DomBus integration does not work anymore: please check the following GitHub pages to get DomBus modules working with Home Assistant**:
* [https://github.com/CreasolTech/DomBusGateway](https://github.com/CreasolTech/DomBusGateway) to install **DomBusGateway** software, providing a **bridge between DomBus and MQTT-AutoDiscovery**
* [https://github.com/CreasolTech/homeassistant-addons](https://github.com/CreasolTech/homeassistant-addons) to install the **DomBusGateway addon for HAOS**

***
The following info are left as reference. Don't try to install the DomBus integration because it will not work. _Use the links above for DomBusGateway bridge and addon_!
...
<a href="https://docs.creasol.it/CreasolCatalog.pdf"><img src="https://images.creasol.it/pdf2.png" alt="Video" style="vertical-align: middle;"/> Download the PDF catalog with application notes!</a>
